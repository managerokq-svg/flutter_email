  ...
  static VBaseMessage createBaseMessage(Map<String, dynamic> map) {
    ...
    switch (type) {
      ...
      case VMessageType.reaction:
        return VReactionMessage.fromRemoteMap(map);
      case VMessageType.sticker:
        return VStickerMessage.fromRemoteMap(map);
      case VMessageType.gif:
        return VGifMessage.fromRemoteMap(map);
      case VMessageType.storyReply:
        return VStoryReplyMessage.fromRemoteMap(map);
      case VMessageType.contact:
        return VContactMessage.fromRemoteMap(map);
    }
  }
  ...
  static VBaseMessage _createMessageFromLocal(Map<String, dynamic> map) {
    ...
    switch (type) {
      ...
      case VMessageType.bug:
        return VEmptyMessage();
      case VMessageType.reaction:
        return VReactionMessage.fromLocalMap(map);
      case VMessageType.sticker:
        return VStickerMessage.fromLocalMap(map);
      case VMessageType.gif:
        return VGifMessage.fromLocalMap(map);
      case VMessageType.storyReply:
        return VStoryReplyMessage.fromLocalMap(map);
      case VMessageType.contact:
        return VContactMessage.fromLocalMap(map);
    }
  }
